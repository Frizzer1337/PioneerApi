package com.devtools.frizzer.pioneerapi.config;
...
public class AppConfig {
    ...
    public AppConfig(CustomerRepository customerRepository, EmailRepository emailRepository) {
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http, JwtAuthFilter jwtAuthFilter) throws Exception {
        return http.csrf(AbstractHttpConfigurer::disable)
                   .authorizeHttpRequests(request -> request.requestMatchers("/customer/login", "/error")
                                                            .permitAll()
                                                            .anyRequest()
                                                            .authenticated())
